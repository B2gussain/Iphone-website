...
const SecondSection = () => {
  ...
  const images = [
    {
      heading: "Heat-forged aluminum unibody design for exceptional pro capability.",
      img: isLargeScreen
        ? "/images/second_img_first.jpg"
        : "/images/second_img_one.jpg",
    },
    {
      heading: "A19 Pro, vapour-cooled for lightning-fast performance. Breakthrough battery life.",
      img: "/images/second_img_sec.jpg",
    },
    {
      heading: "The ultimate pro camera system. All 48MP Fusion rear cameras. And the longest zoom ever on an iPhone.",
      img: "/images/second_img_third.jpg",
    },
    {
      heading: "New Center Stage front camera. Flexible ways to frame your shot. Smarter group selfies. And so much more.",
    ...
    {
      heading: "Apple Intelligence. Effortlessly helpful features — from image creation to Live Translation.",
...
>
        {images.map((item, idx) => (
          <SwiperSlide key={idx} className="pb-10 px-3 flex justify-center items-center">
...
<p
  className={`${idx == "1" ? "bottom-10" : idx == "2" ? "top-8" : "top-10"} absolute text-center font-semibold w-[80%] md:[70%] lg:w-[40%] md:text-3xl -translate-x-1/2 left-1/2`}
>
  {idx == 5 ? (
    <>
