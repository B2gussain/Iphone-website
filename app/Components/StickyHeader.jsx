...
const StickyHeader = () => {
  ...
  return (
    <div
      className={`fixed left-1/2 -translate-x-1/2 w-[90%] flex justify-between items-center py-2 sm:py-3 px-3 sm:px-5 border-[1px] border-[white]/20 rounded-2xl bg-[black]/40 mx-auto transition-all duration-700 z-50
        ${show 
